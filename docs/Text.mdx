...
- `color?`: `string` (name from your color object, if it can't found it'll use it as color)
- `fontFamily?`: `string` (name from your fonts object, if nothing is supplied and you specified something as base in your fonts object, it'll be used)
- `fontSize?`: `number` (index to use from your space array, if negative or higher, it'll use it as size)
- `letterSpacing?`: `number` (index to use from your space array, if negative or higher, it'll use it as spacing)
